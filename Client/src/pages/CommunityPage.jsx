...
const CommunityPage = () => {
    ...
    const dummyPosts = [
        {
            ...
            description: "Walking through the Arashiyama Bamboo Grove at sunrise is a spiritual experience. The way the light filters through the towering stalks is simply magical. The sound of rustling leaves combined with the early morning mist creates an atmosphere of pure tranquility.",
        ...
        },
        {
            ...
            description: "From spicy Pad Thai to sweet Mango Sticky Rice, the street food scene in Bangkok is unparalleled. We spent 4 hours just eating through the Yaowarat Night Market. The energy is infectious and the flavors are bold.",
            imageUrl: "https://unsplash.com/photos/two-auto-rickshaw-on-the-street--y3sidWvDxg",
        ...
        },
        {
            ...
            description: "The classic white walls and blue domes look even better in person during the golden hour. A bit touristy but absolutely worth the trip at least once. The view over the caldera as the sun dips below the horizon is something you'll never forget.",
    ...
    const handleCopyTrip = (e, post) => {
        ...
        setTimeout(() => {
            setIsCopying(false);
            alert(`Great! "${post.placeName}" has been copied to your personal trips.`);
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                {/* Hero / Header Section */}
                <div className="bg-gradient-to-br from-red-600 via-red-700 to-red-900 rounded-[2.5rem] p-12 mb-10 text-center shadow-2xl shadow-red-200/50 relative overflow-hidden border border-red-500/20">
                    {/* Decorative Elements */}
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
                            Explore the world through <span className="text-red-200">other's eyes</span>
                        </h2>
                        <p className="text-lg text-red-50 mb-10 leading-relaxed font-medium opacity-90">
                            Join our global community of passionate travelers. Share your adventures, discover hidden gems, and get inspired for your next journey.
                        </p>
                        <button
                            onClick={() => setShowForm(!showForm)}
                            className="bg-white text-red-600 px-10 py-4 rounded-2xl hover:bg-gray-50 hover:scale-105 active:scale-95 transition-all duration-300 font-bold uppercase tracking-wider shadow-2xl shadow-black/10 flex items-center gap-3 mx-auto group"
                        >
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl border border-red-100 p-8 mb-12 animate-fade-in-up">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 font-medium">Help others discover new places</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-gray-700 ml-1">Place Name</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-gray-700 ml-1">Experience Description</label>
                                <textarea
                                    required
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-gray-700 ml-1">Key Travel Tip</label>
                                    <div className="relative">
                ...
                {loading ? (
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-3xl border-2 border-dashed border-gray-200 py-20 text-center">
                        ...
                        <p className="text-gray-500 max-w-sm mx-auto font-medium">Try adjusting your search or filters to find what you are looking for.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredPosts.map((post) => (post._id !== "placeholder" && (
                            <div
                                key={post._id}
                            ...
                            >
                                ...
                                <div className="relative h-64 overflow-hidden bg-gray-100 group">
                                    ...
                                    <img
                                        src={post.imageUrl || "https://images.unsplash.com/photo-1488646953014-85cb44e25828?q=80&w=1000"}
                                        alt={post.placeName}
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center text-red-600 font-black overflow-hidden shadow-inner border border-red-50">
                                            {post.userImage ? (
                                                ...
                                                <span className="text-lg">{post.userName?.charAt(0).toUpperCase() || "U"}</span>
                                            )}
                                        </div>
                                        <div>
                                            <p className="text-sm font-black text-gray-900">{post.userName}</p>
                ...
                {selectedPost && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 sm:px-6">
                        ...
                        {/* Modal Content */}
                        <div className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row animate-scale-up">
                            {/* Close Button */}
                            <button
                                onClick={() => setSelectedPost(null)}
                                className="absolute top-6 right-6 z-10 p-3 bg-white/80 backdrop-blur-sm rounded-2xl text-gray-900 shadow-lg hover:bg-red-50 hover:text-red-600 transition-all duration-300"
                            >
                                <X size={24} />
                            </button>
                            ...
                            <div className="w-full md:w-1/2 h-64 md:h-auto bg-gray-100 overflow-hidden shrink-0">
                                <img
                                    src={selectedPost.imageUrl || "https://images.unsplash.com/photo-1488646953014-85cb44e25828?q=80&w=1000"}
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-red-600 to-red-800 flex items-center justify-center text-white font-black overflow-hidden shadow-lg shadow-red-200">
                                                {selectedPost.userImage ? (
                                                    <img src={selectedPost.userImage} alt={selectedPost.userName} className="w-full h-full object-cover" />
                                                ) : (
                                                    <span className="text-xl">{selectedPost.userName?.charAt(0).toUpperCase() || "U"}</span>
                                                )}
                                            </div>
                                            <div>
                                                <p className="font-black text-gray-900 text-lg leading-tight">{selectedPost.userName}</p>
                                    ...
                                    {selectedPost.tips && (
                                        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 flex gap-5">
                                            ...
                                            <div>
                                                <h4 className="font-black text-gray-900 uppercase tracking-widest text-xs mb-2">Pro Travel Tip</h4>
