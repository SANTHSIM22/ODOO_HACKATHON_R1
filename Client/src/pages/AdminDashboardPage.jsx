                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">Add a URL to display an actual image instead of just an emoji</p>
                            </div>
                                        ...
                                        <tr key={trip._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-4 whitespace-nowrap">
                                                <button
                                                    ...
                                                    className={`px-2 py-1 text-xs font-semibold rounded-full ${trip.isActive
