...
function DashboardPage() {
  ...
  const continentImages = {
    Africa:
      "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?auto=format&fit=crop&q=80&w=400",
    Antarctica:
      "https://images.unsplash.com/photo-1516939884455-1445c8652f83?auto=format&fit=crop&q=80&w=400",
  ...
  const categories = [
    "all",
    ...new Set(availableTrips.map((t) => t.category).filter(Boolean)),
  ];
        ...
        <div className="bg-gradient-to-br from-red-600 via-red-700 to-red-900 rounded-[2.5rem] p-8 md:p-16 mb-12 text-left shadow-2xl shadow-red-200/50 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10 border border-red-500/20">
          ...
          <div className="relative z-10 max-w-xl text-center md:text-left w-full">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
              Ready for your{" "}
              <span className="text-red-200">next destination?</span>
            </h2>
            <p className="text-base md:text-lg text-red-50 leading-relaxed font-semibold opacity-90">
              Discover handpicked luxury packages and curated experiences
          ...
          <div className="relative z-10 hidden md:block md:pr-4 lg:pr-8">
            <div className="grid grid-cols-2 gap-3 lg:gap-4">
              <div className="bg-white/10 backdrop-blur-md p-4 lg:p-6 rounded-[1.5rem] lg:rounded-[2rem] border border-white/10 text-white min-w-[140px] lg:min-w-[160px] hover:bg-white/20 transition-all cursor-default group/card">
                <TrendingUp
                  size={24}
                  className="text-red-300 mb-2 lg:mb-3 group-hover/card:scale-110 transition-transform"
                />
                <p className="text-2xl lg:text-3xl font-black">
                  {availableTrips.length}
                </p>
                <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest opacity-60">
                  Trips Available
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-4 lg:p-6 rounded-[1.5rem] lg:rounded-[2rem] border border-white/10 text-white min-w-[140px] lg:min-w-[160px] hover:bg-white/20 transition-all cursor-default group/card">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:flex-none">
              <button
                ...
                className={`w-full md:w-auto px-6 py-4 rounded-2xl border transition-all font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 ${
                  groupBy !== "none"
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-2xl border border-gray-100 z-20 overflow-hidden animate-fade-in-up">
                    {["none", "continent", "category"].map((option) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left text-[10px] font-black uppercase tracking-widest hover:bg-red-50 transition ${
                          groupBy === option ? "text-red-600" : "text-gray-700"
                        }`}
                      >
                        {option === "none"
                          ? "No Grouping"
            ...
            {regionalSelections.map((region) => (
              ...
              >
                <div className="aspect-square relative overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${region.color} opacity-40 group-hover:opacity-20 transition-opacity`}
                  ></div>
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors"></div>

                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                    <p className="text-white font-black text-xs uppercase tracking-widest drop-shadow-md">
                      {region.name}
                    </p>
                  </div>
        ...
        <section className="mb-16">
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-[2.5rem] border-2 border-dashed border-gray-100 p-20 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-2 font-black">
                No matches found
              </h4>
              <p className="text-gray-500 mb-8 font-medium">
                Try searching for something else or explore another continent.
              </p>
            </div>
          ) : (
                          ...
                          <div className="absolute top-6 left-6 flex flex-wrap gap-2">
                            {trip.specialOffer > 0 && (
                              <div className="px-4 py-2 bg-orange-500 text-white rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center gap-2 shadow-lg shadow-orange-200/50">
                                <Zap size={14} />
                                Special ${trip.specialOffer.toLocaleString()}{" "}
                                Off
                              </div>
                            )}
                        ...
                        <div className="p-8 flex-1 flex flex-col">
                          ...
                          <div className="space-y-4 mb-8">
                            ...
                            <div className="flex items-center gap-3 text-gray-500">
                              ...
                              <span className="text-sm font-bold uppercase tracking-tight">
                                {trip.category || "Luxury Experience"}
                              </span>
                            </div>
                          </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-12 border border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-2xl shadow-gray-200/40 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-xl">
              ...
              <p className="text-gray-500 font-medium mb-8">
                Tell our community what you're looking for and get personalized
                recommendations from fellow globe trotters.
              </p>
              <button
                onClick={() => navigate("/community-tab")}
