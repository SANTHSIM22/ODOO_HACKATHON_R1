        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          <div className="mb-6">
            ...
            <p className="text-slate-600">
              Create a personalized trip plan with your own details and
              itinerary
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-2">
                Add a URL to a cover image for your trip
              </p>
            </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            ...
            <li className="flex items-start">
              <span className="mr-2">✓</span>
              <span>
                Add destinations and activities after creating your trip
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2">✓</span>
              <span>
                You have full control over all aspects of your custom trip
              </span>
            </li>
          </ul>
        </div>
